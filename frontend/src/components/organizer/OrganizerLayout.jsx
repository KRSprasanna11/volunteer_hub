...
const OrganizerLayout = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get(
        `https://volunteer-hub-jp64.onrender.com/api/notifications/organizer/${user.id}/unread-count`
      )
  ...
  const toggleNotifications = (e) => {
    ...
    setShowNotifications((prev) => {
      if (!prev) {
        ...
        axios
          .put(
            `https://volunteer-hub-jp64.onrender.com/api/notifications/organizer/${user.id}/mark-read`
          )
